# OpenArena Engine [![Build Status](https://travis-ci.org/OpenArena/engine.png?branch=experimental/latest-libraries-sdl2)](https://travis-ci.org/OpenArena/engine) #

This project is a fork of ioquake3 with OpenArena specific changes to the
client and server.  Unlike the master branch, this includes vorbis and
SDL2 2.0.1 so it will cross compile on Windows with the latest SDL2 release.
